...
const contact = () => {
  ...
  function onMouseEnter(value) {
    ...
    switch(value){
      case 'instagram':
        document.getElementById('text').style.transition = "transform 0.8s ease";
        document.getElementById('text').style.transform = "translateY(" + instagramvalue + "vh) ";
        break
      case 'linkedin':
        document.getElementById('text').style.transition = "transform 0.5s ease";
        document.getElementById('text').style.transform = "translateY(" + linkedIn + "vh) ";

        break
      case 'github':
        document.getElementById('text').style.transition = "transform 1s ease";
        document.getElementById('text').style.transform = "translateY(" + githubvalue+ "vh) ";
        break
    }
  }
  function onMouseLeave(value) {
    switch(value){
      case 'instagram':
        document.getElementById('text').style.transition = "transform 0.5s ease";
        document.getElementById('text').style.transform = "translateY(" + 0 + "vh) ";
        break
      case 'linkedin':
        document.getElementById('text').style.transition = "transform 0.8s ease";
        document.getElementById('text').style.transform = "translateY(" + 0 + "vh) ";
    ...
    <section className="w-100 h-100 relative paddingClass  bg-black  ">
      ...
      <div className="container-fluid">
        ...
        <div className="  d-flex flex-row mt-5 text-white  ">
          ...
          <span className="greeting en"> <b>Pass</b></span>
            <span className="greeting en"><b>Spend</b></span>
            <span className="greeting es"><b>Waste</b></span>
            <span className="greeting de"><b>Invest</b></span>
          </div>
          <span className="closure">&nbsp;my time</span>
        </div>
        <div className="container-fluid h-10">
        <div className="row d-flex justify-around h-100 ">
          <div className="flip-card col iconDiv" onMouseEnter={()=>onMouseEnter('instagram')} onMouseLeave={()=>onMouseLeave('instagram')}>
            <div className="flip-card-inner">
              <div className="flip-card-front flex justify-center items-center">
                <img
                  className="iconSize d-flex"
          ...
          <div className="flip-card col iconDiv" onMouseEnter={()=>onMouseEnter('linkedin')} onMouseLeave={()=>onMouseLeave('linkedin')}>
            <div className="flip-card-inner">
              <div className="flip-card-front flex justify-center items-center">
                <img
                  className="iconSize flex"
          ...
          <div className="flip-card col iconDiv" onMouseEnter={()=>onMouseEnter('github')} onMouseLeave={()=>onMouseLeave('github')}>
            <div className="flip-card-inner">
              <div className="flip-card-front flex justify-center items-center">
                <img
                  className="iconSize flex"
